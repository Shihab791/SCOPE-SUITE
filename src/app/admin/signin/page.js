    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-lg">
        ...
        <div className="bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#3d2a4e] px-7 py-8 text-center">
          ...
          <p className="text-sm text-white/60">Please enter your email and password.</p>
        </div>
        ...
        <div className="px-7 py-7 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="/admin/forgot-password" className="text-xs text-teal-400 font-medium hover:underline">
              Forgot password?
            </a>
          </div>
          ...
          <button
            ...
            className="w-full py-3 mt-1 bg-gray-900 hover:bg-gray-800 active:scale-[0.99] text-white font-semibold rounded-lg text-sm transition"
          >
            Sign in
          </button>
