...
const allUsers = [
  { name: "Abir Hossain",  email: "abid32@gmail.com",           company: "ApexTech" },
  { name: "Arif Biswas",   email: "user123@example.com",        company: "BataCorp" },
  { name: "Maksud",        email: "hello@creativeoutlook.com",  company: "InnoVision" },
  { name: "Noda",          email: "info@innovativeideas.com",   company: "Pioneer Group" },
  { name: "Abid",          email: "support@techsolutions.com",  company: "Zenith Corp" },
  { name: "Julfiqer",      email: "contact@brightfuture.com",   company: "Global Net" },
  { name: "Madhob",        email: "admin@yourdomain.com",       company: "United World" },
  { name: "Sazzat",        email: "admin@yourdomain.com",       company: "Olympus Group" },
  { name: "Sammo",         email: "reachus@smartsolutions.com", company: "Vanguard Ltd" },
  { name: "Rubayet",       email: "reachus@smartsolutions.com", company: "Summit Inc" },
  { name: "Rubayet",       email: "reachus@smartsolutions.com", company: "Stellaris Group" },
  { name: "Tanvir",        email: "tanvir@example.com",         company: "NovaTech" },
  { name: "Rafi",          email: "rafi@webcraft.com",          company: "WebCraft" },
  { name: "Sumaiya",       email: "sumaiya@digitaledge.com",    company: "Digital Edge" },
  { name: "Farhan",        email: "farhan@globalit.com",        company: "Global IT" },
  { name: "Mehedi",        email: "mehedi@skytech.com",         company: "SkyTech" },
  { name: "Sadia",         email: "sadia@creativelab.com",      company: "Creative Lab" },
  { name: "Imran",         email: "imran@nexusbd.com",          company: "Nexus BD" },
  { name: "Lamia",         email: "lamia@techwave.com",         company: "TechWave" },
  { name: "Nabil",         email: "nabil@alphacorp.com",        company: "Alpha Corp" },
  { name: "Bristy",        email: "bristy@deltasys.com",        company: "Delta Sys" },
  { name: "Zahid",         email: "zahid@omegagroup.com",       company: "Omega Group" },
];
...
function Avatar({ name }) {
  ...
  return (
    <div className={`w-9 h-9 rounded-full ${color} flex items-center justify-center text-sm font-bold text-gray-700 flex-shrink-0`}>
...
export default function AdminUsersPage() {
  ...
  const [activeNav, setActiveNav] = useState("Users management");
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex-1 flex flex-col overflow-hidden">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100">
                  <th className="text-left px-6 py-4 text-sm font-semibold text-gray-700 w-56">User</th>
                  <th className="text-left px-4 py-4 text-sm font-semibold text-gray-700">Email</th>
                  <th className="text-left px-4 py-4 text-sm font-semibold text-gray-700">Company Name</th>
            ...
            <div className="flex items-center justify-end px-6 py-4 gap-1 border-t border-gray-100 mt-auto">
              ...
              <button
                onClick={() => setPage(1)}
                disabled={page === 1}
                className="w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:bg-gray-100 disabled:opacity-30 transition text-xs"
              >«</button>
